...
{
    public partial class VDimCorporateHierarchy
    {
        ...
        public string? GcaFcc { get; set; }
        public string? MetrixControlGroup { get; set; }
        public string? UwiDesc { get; set; }
        public string? ValnavBudgetYear { get; set; }
        public string? ValnavBudgetQuarter { get; set; }
        public string? OnProdDataSource { get; set; }
        public string? OnProdDateAccumap { get; set; }
        public string? QbyteLicense { get; set; }
        public string? QbyteSurfaceLocation { get; set; }
        public string? SaskResourceSurcharge { get; set; }
